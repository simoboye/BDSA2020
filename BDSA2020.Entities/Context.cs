...
namespace BDSA2020.Entities
{
    public class Context : DbContext, IContext
    {
        ...
        private ICollection<PlacementDescription> GetDescriptionsData()
        {
           return new[]
            {
                new PlacementDescription { Id = 1, Degree = Degree.Other, MinSalary = 10, MinWorkingHours = 1, MaxWorkingHours = 100, Agreement = false, Location = "Copenhagen", LastApplyDate = new DateTime(2020, 12, 15), Email = "ApplyHere@apply.com", Thumbnail = new Uri("https://starwarsblog.starwars.com/wp-content/uploads/2020/04/best-friend-in-galaxy-chewbacca_TALL.jpg"), Title = "UML designer", Description = "You should be able to do UML diagrams correctly", CompanyId = GetCompanyData()[0].Id},
                new PlacementDescription { Id = 2, Degree = Degree.Bachelor, MinSalary = 100, MinWorkingHours = 10, MaxWorkingHours = 100, Agreement = true, Location = "Copenhagen", LastApplyDate = new DateTime(2020, 12, 10), Email = "ApplyHere@apply.com", Thumbnail = new Uri("https://i.ytimg.com/vi/8gKzaobhhtI/maxresdefault.jpg"), Title = "C# developer", Description = "Join our team in of skilled developers", CompanyId = GetCompanyData()[0].Id},
                new PlacementDescription { Id = 3, Degree = Degree.Master, MinSalary = 200, MinWorkingHours = 15, MaxWorkingHours = 150, Agreement = true, Location = "Aarhus", LastApplyDate = new DateTime(2020, 12, 24), Email = "ApplyHere@apply.com", Thumbnail = new Uri("http://www.omnimatrixindia.com/Images/General/Group-Company.jpg"), Title = "Manager", Description = "We need someone to get things done.", CompanyId = GetCompanyData()[0].Id},
                new PlacementDescription { Id = 4, Degree = Degree.Master, MinSalary = 229, MinWorkingHours = 20, MaxWorkingHours = 150, Agreement = true, Location = "Odense", LastApplyDate = new DateTime(2020, 12, 29), Email = "ApplyHere@apply.com", Thumbnail = new Uri("https://i.ytimg.com/vi/rVYkBvOaMx4/maxresdefault.jpg"), Title = "CEO", Description = "Let's make it happen!", CompanyId = GetCompanyData()[0].Id},
                new PlacementDescription { Id = 5, Degree = Degree.Master, MinSalary = 229, MinWorkingHours = 20, MaxWorkingHours = 150, Agreement = true, Location = "US", LastApplyDate = new DateTime(2020, 12, 27), Email = "ApplyHere@apply.com", Thumbnail = new Uri("https://i.ibb.co/StgTn0h/ascii.png"), Title = "Obama", Description = "Yes we can.", CompanyId = GetCompanyData()[0].Id}
            }; 
        }
